import {ActionIcon, Divider, rem, Tabs, TabsProps} from "@mantine/core";
import {IconMessageCircle, IconPhoto, IconSettings, IconX} from "@tabler/icons-react";
    ...
    return(
        <>
            <StyledTabs
                ...
                <Tabs.List>
                    <Tabs.Tab value="gallery" icon={<IconPhoto size="0.8rem"/>} rightSection={
                        <ActionIcon>
                            <IconX size={"0.9rem"} />
                        </ActionIcon>
                    }>Gallery</Tabs.Tab>
